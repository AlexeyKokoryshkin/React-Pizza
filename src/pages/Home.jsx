    ...
    return (
        <div className="container"> 
            ...
            <div className="content__items">
                {
                    isLoaded ? (items.map((obj) => <PizzaBlock isLoading={true} key={obj.id} {...obj} />)) : Array(10).fill(<PizzaLoadingBlock />) // Деструктуризировал {obj}. В нем хранятся свойства {pizzas} из db.json
                }
            </div>
        </div>
    )
